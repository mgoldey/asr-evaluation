...
setup(
  ...
  entry_points={'console_scripts': ['wer = asr_evaluation.__main__:main']},
  keywords=['word', 'error', 'rate', 'asr', 'speech', 'recognition'],
  classifiers=[
    "Development Status :: 5 - Production/Stable", "Environment :: Console", "Programming Language :: Python",
    "Topic :: Scientific/Engineering :: Artificial Intelligence", "Topic :: Text Processing", "Topic :: Utilities",
